...
//    }
//
//    public EffectInstance(Effect effect, int duration, int amplifier, boolean p_i46814_4_, boolean p_i46814_5_) {
//        this(effect, duration, amplifier, p_i46814_4_, p_i46814_5_, p_i46814_5_);
//    }
//
//    public EffectInstance(Effect effect, int duration, int amplifier, boolean ambient, boolean visible, boolean showIcon) {
//        this(effect, duration, amplifier, ambient, visible, showIcon, (EffectInstance)null);
//    }
//
//    public EffectInstance(Effect effect, int duration, int amplifier, boolean ambient, boolean visible, boolean showIcon, @Nullable EffectInstance hidden) {
//        this.effect = effect;
